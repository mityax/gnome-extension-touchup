...
import {clamp, measureTime, UnknownClass} from "$src/utils/utils";
...
class NavigationBar extends St.Widget {
    ...
    constructor(mode: 'gestures' | 'buttons') {
        ...
        this.windowPositionTracker = new WindowPositionTracker((windows: Meta.Window[]) => {
